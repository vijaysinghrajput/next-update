...
<head>
    ...
    <link href="<?php echo config('app_url'); ?>/public/assets/css/mobile-app.css?v=<?php echo time(); ?>" rel="stylesheet">
    <link href="<?php echo config('app_url'); ?>/public/assets/css/style.css" rel="stylesheet">
    
    <!-- PWA Manifest -->
    <link rel="manifest" href="<?php echo config('app_url'); ?>/public/manifest.json">
    
    <!-- Preload critical resources -->
    <link rel="preload" href="<?php echo config('app_url'); ?>/public/assets/js/mobile-app.js" as="script">
    <link rel="preload" href="<?php echo config('app_url'); ?>/public/assets/css/mobile-app.css" as="style">
