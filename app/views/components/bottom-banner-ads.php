<?php
// Bottom Banner Ads Component
if (empty($bottom_banner_ads)) return;
?>

<div class="mobile-card ad-container bottom-banner-ad">
    <div id="bottomBannerSlider" class="carousel slide" data-bs-ride="carousel" data-bs-interval="6000">
        <?php if (count($bottom_banner_ads) > 1): ?>
            <div class="carousel-indicators">
                <?php foreach ($bottom_banner_ads as $index => $ad): ?>
                    <button type="button" data-bs-target="#bottomBannerSlider" data-bs-slide-to="<?php echo $index; ?>" 
        ...
        <?php if (count($bottom_banner_ads) > 1): ?>
            <button class="carousel-control-prev" type="button" data-bs-target="#bottomBannerSlider" data-bs-slide="prev">
                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                <span class="visually-hidden">Previous</span>
            </button>
            <button class="carousel-control-next" type="button" data-bs-target="#bottomBannerSlider" data-bs-slide="next">
