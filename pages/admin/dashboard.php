                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('/admin/news/' . $news['id'] . '/edit'); ?>" class="btn btn-sm btn-outline-primary">
        ...
        <div class="col-lg-4">
            ...
            <div class="dashboard-card mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="<?php echo base_url('/admin/kyc'); ?>" class="btn btn-sm btn-outline-primary">View All</a>
                </div>
                ...
                <?php else: ?>
                    ...
                    <div class="d-flex align-items-start mb-2 p-2 border rounded">
                        ...
                        <div class="btn-group-vertical btn-group-sm">
                            <a href="<?php echo base_url('/admin/kyc/' . $kyc['id'] . '/approve'); ?>" class="btn btn-success btn-sm">
                                <i class="fas fa-check"></i>
                            </a>
                            <a href="<?php echo base_url('/admin/kyc/' . $kyc['id'] . '/reject'); ?>" class="btn btn-danger btn-sm">
