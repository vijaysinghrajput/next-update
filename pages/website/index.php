...
<div class="mobile-app-container">
    ...
    <!-- Single Loading Section -->
    <div class="loading-section" id="mainLoadingSection" style="display: none;">
        <div class="loading-container">
            ...
            <div class="loading-subtitle">Discovering fresh content for you</div>
        </div>
    </div>
</div>
...
<!-- Homepage Script -->
<?php include __DIR__ . '/../../app/views/components/homepage-script-fixed.php'; ?>
