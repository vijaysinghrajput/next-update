                                    ...
                                    <div class="row">
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="whatsapp_number" name="whatsapp_number" 
                                                   placeholder="+1234567890" value="<?php echo htmlspecialchars($whatsappNumber ?? ''); ?>">
                                            <div class="form-text">Phone number for WhatsApp</div>
                                        </div>
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="call_number" name="call_number" 
                                                   placeholder="+1234567890" value="<?php echo htmlspecialchars($callNumber ?? ''); ?>">
                                            <div class="form-text">Phone number for calls</div>
                                        </div>
