...
if ($_POST) {
    ...
    if (strlen($content) > 500) $errors[] = "Content must be maximum 500 characters.";
...
// Handle delete action - redirect to delete endpoint
if (isset($_POST['delete']) && $editId) {
    redirect('/post-news/' . $editId . '/delete');
}
?>
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="content" name="content" rows="6" 
                      placeholder="Write your news article here (maximum 500 characters)" required><?php echo htmlspecialchars($news['content'] ?? ''); ?></textarea>
            <div class="form-text">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div>
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-<?php echo $editId ? 'save' : 'paper-plane'; ?> me-2"></i>
                    <?php echo $editId ? 'Update Article' : 'Post Article'; ?>
                </button>
            </div>
        </div>
