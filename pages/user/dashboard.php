    ...
    <div class="col-lg-8">
            ...
            <div class="dashboard-card mb-4">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="<?php echo base_url('/my-news'); ?>" class="btn btn-sm btn-outline-primary">View All</a>
                </div>
                
                <?php if (empty($userNews)): ?>
                    <p class="text-muted text-center">No news posted yet. <a href="<?php echo base_url('/post-news'); ?>">Post your first news!</a></p>
                <?php else: ?>
                    <div class="row">
        ...
        <div class="col-lg-4">
            ...
            <div class="dashboard-card">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="<?php echo base_url('/notifications'); ?>" class="btn btn-sm btn-outline-primary">View All</a>
                </div>
