...
// Get user's news (with cache busting)
                ...
                <div class="col-lg-6 mb-4 news-item" data-status="<?php echo $news['is_published'] ? 'published' : 'pending'; ?>">
                    <div class="card h-100">
                        <?php if ($news['featured_image']): ?>
                            <img src="<?php echo base_url('public/' . $news['featured_image']); ?>" class="card-img-top" alt="<?php echo htmlspecialchars($news['title']); ?>" style="height: 200px; object-fit: cover;">
                        <?php else: ?>
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="btn-group btn-group-sm">
                                    <a href="<?php echo base_url('news/' . $news['slug']); ?>" class="btn btn-outline-primary">
...
<div class="dashboard-card">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-2">
            <a href="<?php echo base_url('news'); ?>" class="btn btn-outline-info w-100">
